...
modified: 2023-08-03T01:20:24+08:00
---

# 硬件操作电脑

install snapshot-free oses to eliminate data corruption and save time from rolling back to previous state running virtual machines, or use docker containers with xfs support.
