...
modified: '2023-01-16T12:23:13.424Z'
---
...
因为大家都喜欢看中文字幕 (谁听得懂日语 或者一边听日语一边看英文字幕啊) 尽量不用国外的片源 如果只有国外的 直接机器翻译好了 或者直接语音转文字 不过话说回来 种子下载慢 国内网站广告又多 如果能单独下载字幕 对得上时间长度的话 就可以获取到带字幕的老番
