...
modified: '2023-01-16T09:01:52.075Z'
---
...
利用动漫素材来源定位网站可以锁定剪辑位置 裁剪时间长度要控制 只选取匹配度高的 图片可能加了一些番剧没有的字符或者装饰 ([saucenao](https://saucenao.com/)>75, [trace.moe](https://trace.moe)>75, select top-most) 如果匹配度不高就算了 找下一个
