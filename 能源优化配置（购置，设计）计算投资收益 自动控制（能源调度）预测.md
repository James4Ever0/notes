...
modified: '2023-02-04T05:00:33.028Z'
---
...
[microsoft machine teaching](https://www.microsoft.com/en-us/ai/ai-lab-machine-teaching), [bonsai](https://preview.bons.ai/) ([doc](https://learn.microsoft.com/en-us/bonsai/)) is a low-code platform for autonomous AI systems
...
[NTM (neural turing machine)]() for translation, question answering, planning and decision-making. [tensorflow 1.14.0]() includes it into `tf.contrib` which also has `timeseries` module.
