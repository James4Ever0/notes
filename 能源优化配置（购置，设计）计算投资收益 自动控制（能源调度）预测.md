...
modified: '2023-02-08T05:07:29.568Z'
---
...
[SciML](https://github.com/SciML) is Scientific Computing + Machine Learning Toolbox. It has the best performant [DifferentialEquations.jl](https://github.com/SciML/DifferentialEquations.jl) (can run on CUDA with ease, connect to neural networks) and [NeuralPDE.jl](https://github.com/SciML/NeuralPDE.jl) for Physics-Informed Neural Networks (PINN) and Deep BSDE Solvers of Differential Equations for Scientific Machine Learning (SciML) accelerated simulation
