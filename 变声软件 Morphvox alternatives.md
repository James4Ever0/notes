...
modified: 2022-09-05T00:54:27+08:00
---

# 变声软件 Morphvox alternatives

这期视频就是想和大家聊聊真实的变声器~~
希望大家不要被假变声器贩子骗了，b站充斥着用录音来展示效果的付费变声器视频，
请一定要擦亮耳朵（？）辨别真假，除了完美的伪音能达到无损变声，
目前所有变声器都是有损变声的，都会带一些电音！！！（我有试过正确发声时的无损变声）
本人不支持任何付费变声器。
============
第一次做科普视频啊，视频内提到的变声器以及使用方法是目前市面上的最优解（据我所知）
尼奥和泰蕾莎两个小可爱也是使用了这种方法进行直播，可以说，伪音配合变声器是非常适合长时间使用的。
比起直接使用伪音，这样对嗓子的负担会变小（一部分工作是变声器承担）而且每个人声线不同，这个方法最终呈现的效果也不一样，本音条件好一些的话（像莎莎或者尼奥老师那样）那最终效果就会比较自然和可爱！不过就算是我这种糙汉子音也是可以能够使用出一些效果的！
============
我不提供视频使用的宿主和插件的下载方式，希望有心的、愿意付出时间与努力的观众能最终能修成正果！！
（b站里有很多自己搭建宿主机架的视频，也有丰富的盗版或者免费资源下载）
不过b站里还是有很多盗版资源的，不提倡用  但是自己下来折腾一下，玩一玩我觉得也挺不错！！！
视频内使用的软件插件：
宿主：Studio One 5
