...
modified: '2023-01-15T13:29:31.076Z'
---
...
occrp (anti corruption & crime) aleph is a bad source for getting email (anonymous/unauthorized user can only get hundreds, having no clue what the email relates to). however, it has a tool called [follow the money]() (i have no clue how to use it!) which works with csv files and exports cypher to neo4j
