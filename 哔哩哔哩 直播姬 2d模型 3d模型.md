...
modified: '2023-01-12T22:38:04.208Z'
---
...
search for "vtuber" along with "motion capture" you will get many head-only trackers and renderers for windows but not linux. many support one single image as input instead of 2d/3d models
