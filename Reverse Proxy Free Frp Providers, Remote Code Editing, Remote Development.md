...
modified: '2022-08-13T19:09:41.394Z'
---
...
kali:
```bash
sudo edge -c <name> -k <password> -a 192.168.100.1 -f -l n2n.laiyx.win:10090 -l nton.eu.org:10090 -l n2n.lu8.win:10090 -l 	n2n.haoren.eu.org:10090 -Er -A3 -e auto
```
