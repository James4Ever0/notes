...
modified: '2022-08-12T04:44:55.931Z'
---
...
kali:
```bash
sudo edge -c kali_network -k  -a 192.168.100.1 -f -l n2n.laiyx.win:10090
```

macos, since we use sudo you might consider doing it with system service:
```bash
$ sudo edge -c kali_network -k  -a 192.168.100.2 -f -l n2n.laiyx.win:10090
```
