...
modified: '2022-08-23T14:56:30.843Z'
---
...
you may also want to quantize these intervals, set them to nearest possible points. 用到某采样率 还是根本不用吧 就是属于那个区间的离散点上面执行相应的操作变化 怎么用呢 所有的全部弄到一个列表里面 还是选取最小的那个来用？
