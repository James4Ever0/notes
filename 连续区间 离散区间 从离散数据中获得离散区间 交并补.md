...
modified: '2022-08-23T02:29:57.431Z'
---
...
markers = {"enter":[], "exit":[]}
mSetCandidate = [mSet, mSet2]

for index, mSetCandidate in enumerate(mSetCandidate):
  markers["enter"].update(enterList)
  markers["exit"].update(exitList)
