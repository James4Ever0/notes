...
modified: '2022-08-23T06:55:16.408Z'
---
...
you may also want to quantize these intervals, set them to nearest possible points. 用到某采样率 怎么用呢 所有的全部弄到一个列表里面 还是选取最小的那个来用？
