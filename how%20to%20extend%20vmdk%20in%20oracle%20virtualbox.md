...
win 7 æ©å®¹:
å¼å§èå è®¡ç®æº å³é® ç®¡ç å­å¨ ç£çç®¡ç
...
VBoxManage showhdinfo âC:\Users\panong\VirtualBox VMs\CENTOS-6.7\D0.vmdkâ

Run the command to resize:

VBoxManage modifyhd âC:\Users\panong\VirtualBox VMs\CENTOS-6.7\D0.vmdkâ --resize 50000
...
7.png
Create a new VMDK âdynamicâ disk

VBoxManage createhd âfilename âC:\Users\panong\VirtualBox VMs\CENTOS-6.7\D11.vmdkâ --size 50000

Clone old disk to the newly created disk
VBoxManage clonehd âC:\Users\panong\VirtualBox VMs\CENTOS-6.7\D0.vmdkâ --existing âC:\Users\panong\VirtualBox VMs\CENTOS-6.7\D11.vmdkâ
...
Now, you should have made a backup of your vdi at this point. If you havenât go back and do that â so many things can go wrong here and you are on your own!
...
Device â-> Create Partition Table

It should be back to main screen, click on New â-> Add (it should have selected all the free space - 20000MiB) â-> Add
