...
modified: '2022-08-13T07:48:05.011Z'
---

# gitter developer tokens and qq opqbot

关于自动加群 可以考虑使用安卓手机自启动功能（需要下载[startup manager](https://play.google.com/store/apps/details?id=imoblife.startupmanager) 或者[boot manager]() ，有root权限和xposed框架） 用[termux-appium] 自动操作手机在联网的情况下自启动加群
