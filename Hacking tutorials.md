...
modified: '2023-01-17T23:31:56.887Z'
---

别动不动就想日站 收集信息 熟悉工具 做好能做到的 把一路学到的经验总结下来

botnet ips are detected by some websites like [URLHaus](). there's a tendency to use common passwords to bruteforce the credential for such botnets, such as [inori miral cnc scraper](https://github.com/PyLore/Inori-Mirai-CNC-Scraper-V.1), [](). setting botnets by yourself has advantage of connecting to machines without public ip.
