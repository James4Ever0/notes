...
someone prefers [bert4keras]() since it implements multiple LLM into Keras, also easy for LoRA training (by adding a single layer)
...
[chatpaper](https://github.com/kaixindelele/ChatPaper) summarize paper content. similar website: [typeset.io](https://typeset.io/) (can ask questions and explain confusing text, math symbols and tables)
