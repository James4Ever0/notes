...
modified: '2022-12-12T16:53:52.583Z'
---
...
using `apt` one can retrieve package infos with simple command. find main metapackages like `parrot-tools-allfirst, then retrieve dependency trees.
