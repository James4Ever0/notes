...
modified: '2022-12-13T16:29:58.882Z'
---
...
you also have `brew` `sdkman` `macport` `chocolatey` `scoop` `snap` `portage` `conda` `flatpak` `rpm` `urpm` `yum` `cargo` `dnf` indexes and more to scrape. maybe it is time to improve your searching skill? (**select few web domains you want to learn things from, then perform the query, still you have to deal with keywords generation and site selection**)
